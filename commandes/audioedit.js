            ...
            if (msgRepondu.audioMessage) {
                ...
                try {
                    exec(`ffmpeg -i ${media} ${set} ${ran}`, (err, stderr, stdout) => {
                        fs.unlinkSync(media);
                        if (err) return repondre("Erreur durant la procédure : " + err);
                ...
                repondre("La commande ne fonctionne qu'avec des messages audio");
            }
        } else {
            repondre("Veuillez mentionner un audio");
        }
    }
);
