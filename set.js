...
module.exports = { session: process.env.SESSION_ID || 'Put Session Id here',
    ...
    NUMERO_OWNER : process.env.NUMERO_OWNER || "509......",              
    AUTO_READ_STATUS: process.env.AUTO_READ_STATUS || "oui",
    AUTO_DOWNLOAD_STATUS: process.env.AUTO_DOWNLOAD_STATUS || 'non',
    BOT : process.env.BOT_NAME || 'DRK-ST-V3',
    URL : process.env.BOT_MENU_LINKS || 'https://telegra.ph/file/9e6011a5890dd05586b6e.jpg',
